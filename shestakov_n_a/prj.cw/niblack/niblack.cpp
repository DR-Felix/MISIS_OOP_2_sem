...
void NiblackBinarization::plotValues(const std::string& file_path, const std::vector<double>& local_intensity, const std::vector<double>& mean_values, const std::vector<double>& variance_values, const std::vector<double>& threshold_values, int selected_row) {
    
    fs::path directoryPath = fs::path(file_path).remove_filename();
